...
## 🚨 STEP -1: TOOL PREFETCH (MANDATORY, RUNS ONCE BEFORE ANY WORK)

**The very first action in any session that triggers this skill, before reading files, before HubSpot, before LinkedIn, before anything, is a single pair of ToolSearch calls that load every tool schema needed for the full run. Do this ONCE. After this step, no further ToolSearch calls are needed.**

Run ONE ToolSearch call (max_results=9):

```
ToolSearch({
  query: "select:mcp__df6165ad-588c-41c3-b9f1-2113e2a3b91a__search_crm_objects,mcp__df6165ad-588c-41c3-b9f1-2113e2a3b91a__manage_crm_objects,mcp__df6165ad-588c-41c3-b9f1-2113e2a3b91a__get_crm_objects,mcp__df6165ad-588c-41c3-b9f1-2113e2a3b91a__search_owners,mcp__4ba1185f-93a5-43f3-9910-49e11601259c__search_contacts,mcp__4ba1185f-93a5-43f3-9910-49e11601259c__enrich_contacts,mcp__4ba1185f-93a5-43f3-9910-49e11601259c__enrich_news,mcp__4ba1185f-93a5-43f3-9910-49e11601259c__enrich_scoops",
  max_results: 9
})
```

Then immediately run a SECOND ToolSearch call (max_results=9):
...
**If a tool schema was already loaded earlier in the conversation:** skip that tool from the prefetch. Already-loaded schemas stay live for the session.

**Why this rule exists:** Without prefetch, ToolSearch calls interrupt the run every time a new tool category is needed. Brian wants to say "go" and have zero interruptions. Prefetching all schemas at session start eliminates every mid-run ToolSearch call.
