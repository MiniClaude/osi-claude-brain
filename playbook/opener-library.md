# Cold Call Opener Library, 12 openers

Used by qualification when writing the LIVE CALL SCRIPT in the strategy note. Pick the one that fits role + vertical.
...
4. Voicemails: 15 seconds max. No phone number. End with Andy's email spelled audibly ("that's andy at osiglobal dot com"). Always present or future tense.
