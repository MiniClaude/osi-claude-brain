---
name: adam-morris-gft-email-5
description: Email 5 to Adam Morris at GFT — Any thoughts reply
---

Send a reply to Adam Morris at GFT using Outlook. This must be a REPLY in the original thread, not a new email.

1. Navigate to https://outlook.office.com in Chrome
2. If a login screen appears, stop and notify the user
3. Go to Sent Items
4. Find the oldest email sent to amorris@gftinc.com — that is the original cold outreach with subject "130 offices of inherited gear"
