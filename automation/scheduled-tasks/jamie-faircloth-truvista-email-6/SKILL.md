---
name: jamie-faircloth-truvista-email-6
description: Email 6 to Jamie Faircloth (TruVista) — pattern interrupt, yes/no EOL question
---
...
5. Click the Subject field and enter exactly: Yes or no: running any EOL gear right now?
...
Running any Cisco gear that's hit end of life or is getting close?

If yes, it's worth a 15 minute conversation. Systain covers it without a refresh. If no, I'll get out of your inbox.
