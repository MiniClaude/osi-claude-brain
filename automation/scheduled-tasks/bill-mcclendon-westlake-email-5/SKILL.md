---
name: bill-mcclendon-westlake-email-5
description: Email 5 — Breakup email to Bill McClendon at Westlake
---
...
5. Click the Subject field and enter exactly: closing the loop on Westlake
...
I'll leave it here. OSI has been involved with Westlake for a few years and I'd like to think we've built enough goodwill for another conversation down the road.

When the timing is right on the network, Aruba, or anything else on the infrastructure side, feel free to reach out.
