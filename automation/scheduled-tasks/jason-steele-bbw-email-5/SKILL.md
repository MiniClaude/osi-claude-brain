---
name: jason-steele-bbw-email-5
description: Email 5 of 7 to Jason Steele at Bath & Body Works — Any thoughts? reply in thread
---

Send a reply to Jason Steele at Bath & Body Works using Outlook. This must be a REPLY in the original thread, not a new email.

1. Navigate to https://outlook.office.com in Chrome
2. If a login screen appears, stop and notify the user
3. Go to Sent Items
4. Find the oldest email sent to jasteele@bbw.com — that is the original cold outreach
