---
name: tarl-smith-dematic-email-6
description: Email 6 of 7 to Tarl Smith at Dematic — pattern interrupt
---
...
5. Click the Subject field and enter exactly: One question
...
Does your current cost picture include on-prem networking or server gear still on OEM maintenance contracts, especially anything the OEM has already EOL'd?

If yes, that's usually quick money to recover. If no, I'll stop crowding your inbox.
