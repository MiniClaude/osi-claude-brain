---
name: abdi-mohamed-emerson-email-7
description: Send Email 7 (Breakup) to Abdi Mohamed at Emerson
---
...
2. If a login screen appears, STOP and notify Brian via a notification — do not attempt to send the email. Also create a todo in the task list titled "Outlook session expired — resend Abdi Email 7" so Brian can recover manually.
3. Click New mail
...
6. Click the Subject field and enter exactly: No hard feelings
...
I've sent several notes over the past few weeks. You're probably slammed, or maybe this isn't a fit, or timing's just off. Any of those, I get it.

No hard feelings. If anything changes and you want to circle back, you have my info.
