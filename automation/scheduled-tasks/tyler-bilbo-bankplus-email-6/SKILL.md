---
name: tyler-bilbo-bankplus-email-6
description: Send Email 6 to Tyler Bilbo at BankPlus — pattern interrupt, EOL question
---
...
5. Click the Subject field and enter exactly: Yes or no: any Cisco gear coming up on end of life?
...
Is any of the Cisco gear running at BankPlus coming up on end of life in the next 12 months?

If yes, it's worth a 15 minute call. We cover EOL platforms under Systain, no forced refresh required. If no, I'll stop here.
