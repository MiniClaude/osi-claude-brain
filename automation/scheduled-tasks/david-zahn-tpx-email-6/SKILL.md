---
name: david-zahn-tpx-email-6
description: Email 6 of 7 to David Zahn at TPx — pattern interrupt
---
...
5. Click the Subject field and enter exactly: Are you running anything past OEM support?
...
Quick question: is there hardware in your environment running past OEM support — gear you're keeping alive because the replacement cost or lead time isn't worth it right now?

If yes, that's exactly where we tend to be useful. If no, I'll stop sending notes.
