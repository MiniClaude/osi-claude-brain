---
name: zach-blitz-epic-games-email-5
description: Email 5 of 7 to Zach Blitz at Epic Games — Any thoughts? reply in thread
---

Send a reply to Zach Blitz at Epic Games using Outlook. This must be a REPLY in the original thread, not a new email.

1. Navigate to https://outlook.office.com in Chrome
2. If a login screen appears, STOP and notify Brian via a notification — do not attempt to send the email. Also create a todo in the task list titled "Outlook session expired — resend Zach Blitz Email 5" so Brian can recover manually.
3. Go to Sent Items
4. Find the oldest email sent to zach.blitz@epicgames.com — that is the original cold outreach with subject "Your OEM support bill"
