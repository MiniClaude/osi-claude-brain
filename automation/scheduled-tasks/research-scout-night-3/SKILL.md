---
name: research-scout-night-3
description: Nightly research scout run #3 (5am) — third sweep before business day, focusing on vendor/trade news
---
...
3. Extract 5–8 specific search themes from this context — targeted topics where new developments (EOL notices, product launches, best-practice shifts, market changes) would matter. Focus on VENDOR and TRADE sources this run: OEM announcements, press releases, trade publication coverage, analyst reports, and industry news.
4. Run 15–25 web searches across general web, vendor blogs, trade publications (The Register, SDxCentral, Light Reading, Network World, CRN), and any relevant news sources.
