---
name: robert-creel-astound-email-7
description: Email 7 of 7 to Robert Creel at Astound Broadband — breakup email
---
...
2. If a login screen appears, STOP and notify Brian via a notification — do not attempt to send the email. Also create a todo in the task list titled "Outlook session expired — resend Robert Creel Email 7" so Brian can recover manually.
3. Click New mail
...
I've sent a few notes over the past month and nothing landed — no hard feelings.

If things shift — the GFiber integration creates an optics gap, a maintenance contract comes up for renewal, or the budget just needs another option — I'm easy to find.
