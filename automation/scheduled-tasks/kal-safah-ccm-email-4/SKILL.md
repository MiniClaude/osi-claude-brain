---
name: kal-safah-ccm-email-4
description: Send Email 4 (swag/address confirm) to Kal Safah at CrossCountry Mortgage
---
...
2. If a login screen appears, STOP and notify Brian via a notification — do not attempt to send the email. Also create a todo in the task list titled "Outlook session expired — resend Kal Email 4" so Brian can recover manually.
3. Click New mail
