---
name: jamie-faircloth-truvista-email-5
description: Email 5 to Jamie Faircloth (TruVista) — reply in original thread: Any thoughts?
---

Send a reply to Jamie Faircloth at TruVista using Outlook. This must be a REPLY in the original thread, not a new email.

1. Navigate to https://outlook.office.com in Chrome
2. If a login screen appears, stop and notify the user
3. Go to Sent Items
4. Find the oldest email sent to jfaircloth@truvista.biz — that is the original cold outreach
