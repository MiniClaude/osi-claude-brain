---
name: ty-scottino-jackhenry-email-7
description: Email 7 to Ty Scottino at Jack Henry — breakup
---
...
2. If a login screen appears, STOP and notify Brian via a notification — do not attempt to send the email. Also create a todo in the task list titled "Outlook session expired — resend Ty Scottino Email 7" so Brian can recover manually.
3. Click New mail
...
I've sent a few notes over the past month without hearing back. I get it -- you're busy and the timing may just not be right.

I won't keep following up. If you ever need a fast source for optics, pre-owned Cisco or Arista gear, or want to benchmark what you're paying for OEM support, I'm easy to reach. My info is below.
