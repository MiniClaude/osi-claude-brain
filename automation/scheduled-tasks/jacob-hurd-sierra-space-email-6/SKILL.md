---
name: jacob-hurd-sierra-space-email-6
description: Email 6 to Jacob Hurd (Sierra Space) — pattern interrupt — May 29 @ 9:00 AM PT
---
...
2. If a login screen appears, STOP and notify Brian via a notification — do not attempt to send the email. Also create a todo in the task list titled "Outlook session expired — resend Jacob Hurd Email 6" so Brian can recover manually.
3. Click New mail
...
6. Click the Subject field and enter exactly: Still running anything past OEM support?
...
Quick one: are you running any servers or networking gear past OEM support windows right now?

If yes, worth a quick call. If no, I will leave you alone.
