---
name: jamie-faircloth-truvista-email-3
description: Email 3 to Jamie Faircloth (TruVista) — soft touch (rescheduled from Sat 4/25 to Mon 4/27)
---
...
5. Click the Subject field and enter exactly: Fiber ISP problems I keep running into
...
I get it. Your inbox is not exactly empty.

I keep hearing the same thing from IS directors at regional fiber ISPs: the OEM relationship looks fine until the bill comes in or a refresh notice lands, and then it doesn't. By then the budget conversation is already happening and the timeline is tight.

If that's not where TruVista is right now, no problem at all. Just say the word and I'll leave you alone. If any of it sounds familiar, I'm easy to reach.
