---
name: ty-scottino-jackhenry-email-6
description: Email 6 to Ty Scottino at Jack Henry — EOL pattern interrupt
---
...
2. If a login screen appears, STOP and notify Brian via a notification — do not attempt to send the email. Also create a todo in the task list titled "Outlook session expired — resend Ty Scottino Email 6" so Brian can recover manually.
3. Click New mail
...
6. Click the Subject field and enter exactly: Are you running any EOL gear right now?
...
Quick question: are you running any network equipment approaching end of life, or sitting on an OEM support contract coming up for renewal?

If yes, worth talking. If no, I'll stop following up.
