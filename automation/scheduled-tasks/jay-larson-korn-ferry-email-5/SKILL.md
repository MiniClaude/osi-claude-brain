---
name: jay-larson-korn-ferry-email-5
description: Jay Larson @ Korn Ferry — Email 5 (any thoughts reply)
---

Send a reply to Jay Larson at Korn Ferry using Outlook. This must be a REPLY in the original thread, not a new email.

1. Navigate to https://outlook.office.com in Chrome
2. If a login screen appears, STOP and notify Brian via a notification — do not attempt to send the email. Also create a todo in the task list titled "Outlook session expired — resend Jay Larson Email 5" so Brian can recover manually.
3. Go to Sent Items
4. Find the oldest email sent to jay.larson@kornferry.com — that is the original cold outreach with subject "Does Korn Ferry buy memory direct"
