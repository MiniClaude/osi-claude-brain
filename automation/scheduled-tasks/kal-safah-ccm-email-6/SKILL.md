---
name: kal-safah-ccm-email-6
description: Send Email 6 (optics refresh question) to Kal Safah at CrossCountry Mortgage
---
...
2. If a login screen appears, STOP and notify Brian via a notification — do not attempt to send the email. Also create a todo in the task list titled "Outlook session expired — resend Kal Email 6" so Brian can recover manually.
3. Click New mail
...
6. Click the Subject field and enter exactly: Optics refresh question
...
Quick yes-or-no: are you planning any infrastructure refresh or data center upgrades in the next 12 months that would touch branch connectivity or core optics?

If yes, worth a conversation. If no, I'll stop reaching out.
