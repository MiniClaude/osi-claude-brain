---
name: abdi-mohamed-emerson-email-2
description: Send Email 2 (Different Angle) to Abdi Mohamed at Emerson
---
...
2. If a login screen appears, STOP and notify Brian via a notification — do not attempt to send the email. Also create a todo in the task list titled "Outlook session expired — resend Abdi Email 2" so Brian can recover manually.
3. Click New mail
...
6. Click the Subject field and enter exactly: When OEMs stop supporting your gear
...
Following up. Here's what keeps coming up: equipment hits EOL, OEMs either ghost you or charge like crazy for support.

We keep legacy infrastructure running long after OEM walks away. We can also bridge you to new gear without the forklift replacement. A lot of network architects like that option.
