---
name: zach-blitz-epic-games-email-4
description: Email 4 of 7 to Zach Blitz at Epic Games — swag/address confirm
---
...
2. If a login screen appears, STOP and notify Brian via a notification — do not attempt to send the email. Also create a todo in the task list titled "Outlook session expired — resend Zach Blitz Email 4" so Brian can recover manually.
3. Click New mail
