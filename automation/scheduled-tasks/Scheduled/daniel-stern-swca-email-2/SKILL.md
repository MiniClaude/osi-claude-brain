---
name: daniel-stern-swca-email-2
description: Email 2 of 7 — Daniel Stern, SWCA Environmental — Hardware angle
---
...
2. If a login screen appears, STOP and notify Brian via a notification — do not attempt to send the email. Also create a todo in the task list titled "Outlook session expired — resend Daniel Stern Email 2" so Brian can recover manually.
3. Click New mail
4. In the To field, enter: daniel.stern@swca.com and press Tab
5. Click the Subject field and enter exactly: Hardware for 74 offices at 50-80% off OEM
...
We supply network, server, and storage hardware — Cisco, HPE, Dell, Aruba, Juniper — at 50-80% off OEM list. For a company with 74 locations and field offices that need to stay connected, that number adds up fast.

We carry memory and optics with same-day fulfillment on most configurations. If your team is buying gear for site buildouts or refreshes, it's worth knowing we exist.
