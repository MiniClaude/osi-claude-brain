---
name: quentin-bullock-citizens-email-4
description: Send Quentin Bullock Email 4 (swag/address confirm) via Outlook
---
...
2. If a login screen appears, STOP and notify Brian via a notification — do not attempt to send the email. Also create a todo in the task list titled "Outlook session expired — resend Quentin Bullock Email 4" so Brian can recover manually.
3. Click New mail
