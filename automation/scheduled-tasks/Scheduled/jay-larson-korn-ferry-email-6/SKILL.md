---
name: jay-larson-korn-ferry-email-6
description: Jay Larson @ Korn Ferry — Email 6 (pattern interrupt)
---
...
2. If a login screen appears, STOP and notify Brian via a notification — do not attempt to send the email. Also create a todo in the task list titled "Outlook session expired — resend Jay Larson Email 6" so Brian can recover manually.
3. Click New mail
...
6. Click the Subject field and enter exactly: One direct question
...
Quick one: are you still sourcing server memory and support contracts through Dell or HP directly, or have you brought in a secondary source?

If yes, worth a quick call. If no, I'll stop showing up in your inbox.
