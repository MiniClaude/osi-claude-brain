---
name: stephen-jih-sce-email-3
description: Email 3 of 7 — Soft touch to Stephen Jih at SCE (rescheduled from Sat 4/25 to Mon 4/27)
---
...
5. Click the Subject field and enter exactly: No pressure
...
I know how full network ops calendars get at a utility with SCE's footprint. If the optics cost angle or maintenance coverage isn't relevant right now, just say the word.

If it is relevant and timing is the issue, I'm easy to find when things open up.
