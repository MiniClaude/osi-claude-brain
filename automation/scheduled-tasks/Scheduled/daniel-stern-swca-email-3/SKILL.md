---
name: daniel-stern-swca-email-3
description: Email 3 of 7 — Daniel Stern, SWCA Environmental — Soft touch
---
...
2. If a login screen appears, STOP and notify Brian via a notification — do not attempt to send the email. Also create a todo in the task list titled "Outlook session expired — resend Daniel Stern Email 3" so Brian can recover manually.
3. Click New mail
4. In the To field, enter: daniel.stern@swca.com and press Tab
5. Click the Subject field and enter exactly: If the timing is off, just say the word
...
Not trying to fill your calendar with things that aren't relevant. If EOL coverage or hardware pricing isn't on your radar right now, say so and I'll stop.

What I see at companies like yours is IT leadership sitting on OEM contracts that were signed in a different budget environment, and now they're looking for ways to get the same coverage for less. If that's somewhere on your list, we should talk.
