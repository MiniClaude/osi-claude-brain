---
name: robert-creel-astound-email-6
description: Email 6 of 7 to Robert Creel at Astound Broadband — pattern interrupt
---
...
2. If a login screen appears, STOP and notify Brian via a notification — do not attempt to send the email. Also create a todo in the task list titled "Outlook session expired — resend Robert Creel Email 6" so Brian can recover manually.
3. Click New mail
...
6. Click the Subject field and enter exactly: One quick question
...
When your network team needs an optic in a hurry — unplanned outage, port swap, something the integration throws at you — is there already a secondary supplier in place or does it always go back to the OEM?

If yes, worth talking. If no, I'll stop.
