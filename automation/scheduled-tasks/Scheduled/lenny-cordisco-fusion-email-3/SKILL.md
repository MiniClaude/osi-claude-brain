---
name: lenny-cordisco-fusion-email-3
description: Email 3 to Lenny Cordisco at Fusion Worldwide — soft touch (rescheduled from Sat 4/25 to Mon 4/27)
---
...
5. Click the Subject field and enter exactly: Quick check-in
...
Global IT directors managing 20-plus offices usually have a lot on their plates. I get it if my timing was off.

If the OEM maintenance costs or hardware sourcing aren't the problem right now, no problem at all. If they are, I'm easy to reach and worth a quick call before the next budget cycle.
