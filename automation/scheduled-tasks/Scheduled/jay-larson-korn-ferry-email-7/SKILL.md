---
name: jay-larson-korn-ferry-email-7
description: Jay Larson @ Korn Ferry — Email 7 (breakup)
---
...
2. If a login screen appears, STOP and notify Brian via a notification — do not attempt to send the email. Also create a todo in the task list titled "Outlook session expired — resend Jay Larson Email 7" so Brian can recover manually.
3. Click New mail
...
I've sent a few notes over the past month and haven't heard back. Totally fair — the timing may just be off.

Getting out of your inbox. If server memory costs or support contracts come up down the road, I'm easy to find. bc@osihardware.com.
