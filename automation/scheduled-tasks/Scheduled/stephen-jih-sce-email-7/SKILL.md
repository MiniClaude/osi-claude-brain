---
name: stephen-jih-sce-email-7
description: Email 7 of 7 — Breakup email to Stephen Jih at SCE
---
...
5. Click the Subject field and enter exactly: Last note
...
I've sent several notes over the past few weeks without a response. I get it — if it's not the right time or the right fit, no problem.

If SCE ever needs optics sourcing, certification support, or maintenance coverage for aging infrastructure, OSI Global is here. No follow up after this.
