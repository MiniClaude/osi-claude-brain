---
name: michael-lowe-morgan-white-email-4
description: Send Email 4 (swag/address confirm) to Michael Lowe at Morgan White Group
---
...
2. If a login screen appears, STOP and notify Brian via a notification — do not attempt to send the email. Also create a todo in the task list titled "Outlook session expired — resend Michael Lowe Email 4" so Brian can recover manually.
3. Click New mail
