---
name: jacob-hurd-sierra-space-email-4
description: Email 4 to Jacob Hurd (Sierra Space) — swag/address confirm — May 25 @ 9:00 AM PT
---
...
2. If a login screen appears, STOP and notify Brian via a notification — do not attempt to send the email. Also create a todo in the task list titled "Outlook session expired — resend Jacob Hurd Email 4" so Brian can recover manually.
3. Click New mail
