---
name: tyler-bilbo-bankplus-email-7
description: Send Email 7 to Tyler Bilbo at BankPlus — breakup email
---
...
I've sent several notes over the past few weeks without hearing back. I respect that — if it's not the right time, it's not the right time.

If BankPlus ever needs to address maintenance costs on aging Cisco gear or source hardware at something better than OEM pricing, we're here. No follow up after this.
