---
name: frank-simuro-costar-email-7
description: CoStar sequence — Frank Simuro Email 7 breakup
---
...
5. Click the Subject field and enter exactly: I'll let you get back to it
...
I've sent a handful of notes and haven't been able to connect. You're running IT for a company in the middle of a major campus launch, so I understand the inbox is not short on demands.

I'll leave it here. If you ever want a straight conversation about infrastructure costs or alternative support options, reach out. The door is always open.
