---
name: tony-ventura-breezeline-email-6
description: Tony Ventura (Breezeline) — Email 6 — DISABLED: email address bounced 2026-04-22
---

Send Email 6 of Brian Charrette's outreach sequence to Tony Ventura at Breezeline.

RECIPIENT: tventura@breezeline.com
SUBJECT: Are you running any EOL Cisco or Juniper?
FROM: bc@osihardware.com

BODY (type this above Brian's existing signature — do NOT modify or delete the signature):
Quick question: are you running any Cisco or Juniper gear that's hit end of life but still active in production?

If yes, we cover it with full hardware SLA and 24/7 TAC, usually at about half of what Cisco SmartNet costs. If no, I'll stop here.
...
4. Fill in Subject: Are you running any EOL Cisco or Juniper?
