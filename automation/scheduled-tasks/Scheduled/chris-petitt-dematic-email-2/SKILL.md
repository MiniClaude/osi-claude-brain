---
name: chris-petitt-dematic-email-2
description: Email 2 of 7 to Chris Petitt at Dematic — optics angle
---
...
5. Click the Subject field and enter exactly: Transceivers your OEM won't build for you
...
The physical connectivity layer at a company running warehouse automation at Dematic's scale is load bearing in a way most vendors don't address. We build custom optical transceivers from 1G through 400G across 40+ OEM platforms, including configurations the OEMs themselves won't make: extended distances, multi-platform twinax, DWDM coded as SFP+ for platforms that don't natively accept DWDM.

If you have connectivity challenges where off the shelf isn't cutting it, that's a conversation worth having.
