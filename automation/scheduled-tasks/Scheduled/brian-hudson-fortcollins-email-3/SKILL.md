---
name: brian-hudson-fortcollins-email-3
description: Email 3 of 7 — Brian Hudson, City of Fort Collins (soft touch)
---
...
Two notes and nothing back — completely understand. Running a municipal fiber network in active expansion doesn't leave a lot of margin for vendor calls.

I keep seeing the same thing at city-owned networks your size: optics procurement gets expensive fast when you're sourcing from OEMs at list price during a buildout. Figured it was worth getting on your radar as an alternative.

If the timing isn't right, say the word and I'll leave you alone. If there's a conversation worth having down the road, you know where to find me.
