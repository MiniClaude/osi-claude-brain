...
Process the queue at C:\Users\Mini\Documents\osi-claude-brain\automation\email-queue.json for the current ET window (11am, 12pm, 1pm, 2pm, 3pm, or 4pm). Send all due emails via Outlook in Chrome with the Pre-Send Gate, em-dash sanitizer, bi-directional signature trim, and hard-block enforcement per the skill's SKILL.md. Log the run to C:\Users\Mini\Documents\osi-claude-brain\sessions\session-YYYY-MM-DD.md.
