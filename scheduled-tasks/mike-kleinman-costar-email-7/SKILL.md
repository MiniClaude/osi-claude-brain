---
name: mike-kleinman-costar-email-7
description: CoStar sequence — Mike Kleinman Email 7 breakup
---
...
5. Click the Subject field and enter exactly: Taking you off my list unless you say otherwise
...
I've sent a few notes over the past month and haven't heard back. I'll stop here.

If your DIMM costs, SAN maintenance, or server lifecycle ever become a priority, reach out. We can usually put numbers together same-day and have inventory ready to move.

Good luck with the infrastructure work at CoStar.
