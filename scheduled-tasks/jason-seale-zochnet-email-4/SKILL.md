---
name: jason-seale-zochnet-email-4
description: Send Email 4 of 7 to Jason Seale at ZochNet (swag/address confirm)
---
...
2. If a login screen appears, STOP and notify Brian via a notification — do not attempt to send the email. Also create a todo in the task list titled "Outlook session expired — resend Jason Seale Email 4" so Brian can recover manually.
3. Click New mail
