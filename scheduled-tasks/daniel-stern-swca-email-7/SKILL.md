---
name: daniel-stern-swca-email-7
description: Email 7 of 7 — Daniel Stern, SWCA Environmental — Breakup
---
...
2. If a login screen appears, STOP and notify Brian via a notification — do not attempt to send the email. Also create a todo in the task list titled "Outlook session expired — resend Daniel Stern Email 7" so Brian can recover manually.
3. Click New mail
...
Sent a few notes over the past few weeks and haven't heard back. I'll leave it here.

If OSI Global ever comes up in a conversation about maintenance contracts, hardware sourcing, or keeping EOL gear covered, feel free to reach out. Easy to find.
