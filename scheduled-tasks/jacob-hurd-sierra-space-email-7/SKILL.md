---
name: jacob-hurd-sierra-space-email-7
description: Email 7 to Jacob Hurd (Sierra Space) — breakup email — Jun 8 @ 9:00 AM PT
---
...
2. If a login screen appears, STOP and notify Brian via a notification — do not attempt to send the email. Also create a todo in the task list titled "Outlook session expired — resend Jacob Hurd Email 7" so Brian can recover manually.
3. Click New mail
...
6. Click the Subject field and enter exactly: Closing the loop on my end
...
I have sent a handful of notes over the past month and have not been able to connect. I get it, not everything lands at the right time.

I will leave your inbox alone. If the server memory or maintenance conversation ever comes up down the road, you have got my info. Happy to pick it up whenever.
