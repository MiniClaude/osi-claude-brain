---
name: bill-mcclendon-westlake-email-4
description: Email 4 — Pattern interrupt to Bill McClendon at Westlake
---
...
5. Click the Subject field and enter exactly: is it live yet
...
Simple question: is the Cisco equipment from the PC project currently running in production at Westlake?

If yes, there's a TPM conversation worth having before it comes off OEM support. If no, I'll stop bothering you.
