---
name: skill-fix-reminder-work-pc
description: Reminder to apply skill fixes on work PC
---

Send Brian a reminder about the skill fixes from yesterday.
...
4. Restart Cowork on the work PC so it re-reads the skills.

If he also keeps master copies in `Claude-Brain\skills\`, he should overwrite those too (per the sync note in the job-change skill).

Keep the reminder short and direct — he just needs the nudge and the paths. No fluff.