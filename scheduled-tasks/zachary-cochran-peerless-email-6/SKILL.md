---
name: zachary-cochran-peerless-email-6
description: Email 6 of 7 to Zachary Cochran (Peerless/Infobip) — pattern interrupt, Juniper EOL
---
...
5. Click the Subject field and enter exactly: Do you have ticking time bombs in your core
...
Quick yes or no: do you have Juniper MX gear on the Peerless network that's heading toward end of service?

The EOS on several MX platforms hits this June. If that applies to you, it's worth a conversation. If not, I'll stop following up.
