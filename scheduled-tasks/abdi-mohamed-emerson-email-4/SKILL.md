---
name: abdi-mohamed-emerson-email-4
description: Send Email 4 (Swag & SFPs) to Abdi Mohamed at Emerson
---
...
2. If a login screen appears, STOP and notify Brian via a notification — do not attempt to send the email. Also create a todo in the task list titled "Outlook session expired — resend Abdi Email 4" so Brian can recover manually.
3. Click New mail
...
I'm putting together a package for you. Swag and a pair of sample SFPs from the team here.

Do you come in to the office? What's the best address to send it?
