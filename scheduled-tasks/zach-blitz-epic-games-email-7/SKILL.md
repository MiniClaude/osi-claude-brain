---
name: zach-blitz-epic-games-email-7
description: Email 7 of 7 to Zach Blitz at Epic Games — breakup
---
...
2. If a login screen appears, STOP and notify Brian via a notification — do not attempt to send the email. Also create a todo in the task list titled "Outlook session expired — resend Zach Blitz Email 7" so Brian can recover manually.
3. Click New mail
...
I've sent a few notes and haven't heard back, so I'll assume the timing isn't right.

If that changes and you ever want a second opinion on your OEM support spend or a quote on server memory, you know where to find me.
