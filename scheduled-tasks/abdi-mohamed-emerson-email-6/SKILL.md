---
name: abdi-mohamed-emerson-email-6
description: Send Email 6 (Pattern Interrupt) to Abdi Mohamed at Emerson
---
...
2. If a login screen appears, STOP and notify Brian via a notification — do not attempt to send the email. Also create a todo in the task list titled "Outlook session expired — resend Abdi Email 6" so Brian can recover manually.
3. Click New mail
...
6. Click the Subject field and enter exactly: OEM or third-party on cables?
...
Quick one: when you're refreshing transceivers or DAC cables, do you buy OEM or are you open to third-party?

If yes, worth a conversation. If no, I'll stop.
