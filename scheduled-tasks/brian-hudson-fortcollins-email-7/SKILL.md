---
name: brian-hudson-fortcollins-email-7
description: Email 7 of 7 — Brian Hudson, City of Fort Collins (breakup)
---
...
I've sent a few notes over the past few weeks and haven't heard back, so I'll leave you alone.

If you ever need a cost-effective source on optics, cables, or network hardware for the Connexion buildout — OSI is a good call. No pressure, just useful when you need it.

Good luck with the Larimer County expansion.
