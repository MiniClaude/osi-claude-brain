---
name: tyler-bilbo-bankplus-email-5
description: Send Email 5 to Tyler Bilbo at BankPlus — Any thoughts? reply in original thread
---

Send a reply to Tyler Bilbo at BankPlus using Outlook. This must be a REPLY in the original thread, not a new email.

1. Navigate to https://outlook.office.com in Chrome
2. If a login screen appears, stop and notify the user
3. Go to Sent Items
4. Find the oldest email sent to tylerbilbo@bankplus.net — that is the original cold outreach
