---
name: zach-blitz-epic-games-email-6
description: Email 6 of 7 to Zach Blitz at Epic Games — pattern interrupt yes/no
---
...
2. If a login screen appears, STOP and notify Brian via a notification — do not attempt to send the email. Also create a todo in the task list titled "Outlook session expired — resend Zach Blitz Email 6" so Brian can recover manually.
3. Click New mail
...
6. Click the Subject field and enter exactly: One question before I stop emailing
...
One direct question: does Epic have any Cisco or HPE gear currently running on OEM support that's either past end of life or coming up on renewal in the next 12 months?

If yes, that's exactly where we can help. If no, I'll stop emailing.
