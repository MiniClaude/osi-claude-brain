---
name: david-zahn-tpx-email-2
description: Email 2 — David Zahn (TPx) — SENT MANUALLY 4/22 11:40 AM PT
---
...
5. Click the Subject field and enter exactly: You're probably paying double what you need to on maintenance
...
Different thought from my last note.

TPx's scale means you're running a mix of hardware at different stages of life. Some still under OEM support, plenty already past it. Maintenance on that gear adds up fast, especially at OEM rates.

We run Systain, a third-party maintenance program with 24/7/365 TAC coverage at roughly half of what OEMs charge. EOL equipment is fully supported, and Level 2 and Level 3 engineers pick up the phone instead of a tier-1 queue.

If there's gear on contract up for renewal, it might be worth comparing numbers before it auto-renews.
