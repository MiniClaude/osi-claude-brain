---
name: frank-simuro-costar-email-3
description: CoStar sequence — Frank Simuro Email 3 soft touch
---
...
5. Click the Subject field and enter exactly: Not going to oversell this, Frank
...
Two notes, no reply. I get it.

I'll be straight: I'm not going to tell you OSI solves every IT problem you have. We're good at a specific set of things, and if none of those things are on your plate right now, a call would be a waste of both our time.

If cost pressure on hardware or maintenance contracts becomes worth a conversation, I'm easy to find.
