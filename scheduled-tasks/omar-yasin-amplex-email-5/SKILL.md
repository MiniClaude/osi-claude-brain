---
name: omar-yasin-amplex-email-5
description: Email 5 of 7 — Omar Yasin, CTO, Amplex Internet — Any thoughts? (reply in thread)
---

Send a reply to Omar Yasin at Amplex Internet using Outlook. This must be a REPLY in the original thread, not a new email.

1. Navigate to https://outlook.office.com in Chrome
2. If a login screen appears, stop and notify the user
3. Go to Sent Items
4. Find the oldest email sent to oayasin@amplex.net — that is the original cold outreach
