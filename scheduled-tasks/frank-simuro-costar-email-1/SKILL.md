---
name: frank-simuro-costar-email-1
description: CoStar sequence — Frank Simuro Email 1 cold intro
---
...
5. Click the Subject field and enter exactly: The OEM renewal that never gets cheaper
...
I'm Brian at OSI Global. We're Gartner-recognized in IT infrastructure and work with large technology shops that are under pressure to cut costs without disrupting operations.

With CoStar's Richmond campus coming online in May and the company pushing hard on margin expansion this year, I'm guessing IT infrastructure spend is getting a closer look than usual. We help teams reduce hardware and support costs by 50 to 80 percent versus OEM pricing by extending lifecycles, sourcing smarter, and covering gear that OEMs stop supporting.

Would you have 15 minutes to hear what that looks like in practice?
