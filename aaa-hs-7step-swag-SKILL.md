...
- Start with `[First Name],` on its own line (no Hi, no Hello — just the first name followed by a comma)
...
**First name rule (updated 2026-06-01):** Email 1 and Email 3 open with `[First Name],` on its own line. Email 2 ("Any thoughts?") has no salutation — intentionally short.
