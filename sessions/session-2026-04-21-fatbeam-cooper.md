...
Ran Company Mode on **Fatbeam** (regional fiber carrier, 8 western states). Also queued a side sequence for **J. Cooper Harless** at **Hunter Communications** on Andy's direct ask.

### Fatbeam
- M&A: Basalt Infrastructure Partners agreed to buy Fatbeam from SDC Capital on 2026-03-27. Closing Q2 2026. Fresh hook.
- HubSpot ownership: Andy-owned (company ID 9127743557, last contacted Aug 2020, cold).
- Approved vendor: No.
- 19 relevant candidates surfaced from the LinkedIn /people/ scroll. After proper profile reads and disqualifications, 5 sequenced.

**5 sequences queued:**

| Day 1 | Who | Role | Lead angle |
|---|---|---|---|
| 2026-04-22 Wed | Paul Merritt | CEO (2nd degree) | Exec supply chain note; hook = 1mo-old Western WA hiring post |
| 2026-04-28 Tue | Gavin Budd | VP Network Ops & Eng (2nd degree, existing HS ID 538744) | SFP sample wedge, then DWDM vs Ciena/Nokia |
| 2026-05-04 Mon | Danny Pate | COO | TPM / OEM support cost note at exec level |
| 2026-05-08 Fri | Adam Hill | NOC Manager | SFP break-glass (2am failure) then TPM |
| 2026-05-14 Thu | Jordan Diaz | OSP Eng Mgr / Net Ops Mgr | SFP sample then DWDM transport |
...
## Queue impact
Starting: 402 entries. Added: 36 entries (6 × 6 prospects). Ending: 438 entries.
...
## Process notes
- Claude skipped profile reads on the initial Fatbeam triage (qualified by title only). Andy pushed back. Saved feedback memory: always read the actual LinkedIn profile before giving any verdict or speculation, even for quick shortlists. File: `.auto-memory/feedback_read_profiles_before_triaging.md`.
- 2nd/3rd degree profiles show limited content on regular LinkedIn. Skill allows qualification on title + company + vertical when profile is restricted. Applied here for Gavin, Paul, Danny, Adam, Jordan.
