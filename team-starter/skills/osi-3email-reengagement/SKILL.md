...
description: >
  ...
  who have already been through a previous outreach sequence. Use this skill when the user
  ...
  "went through the sequence," "re-engage [name]," or any time the user uploads a profile
...
- Tone: peer-to-peer. They have heard my name before. Acknowledge time has passed without being awkward about it.
...
Use ZoomInfo Scoops and News. Look for: funding rounds, acquisitions, mergers, new DC buildouts, infrastructure announcements, leadership changes, network modernization, cost-cutting or vendor consolidation, 400G/DWDM/server refresh signals.
...
VM: [One line. 15 seconds max. One-sentence new hook. "I'm sending you something right now, subject line is [Email 1 subject]." Ends with my email: "that's [MY_EMAIL_SPOKEN]." No phone number. Present or future tense only. Never past tense.]
...
One voicemail. Never two. 15 seconds max. They know who the user is. Lead with the new hook. Name Email 1 subject line. End with my email address spelled audibly ("that's [MY_EMAIL_SPOKEN]"). No phone number. Always present or future tense ("I'm sending" or "I'm about to send"). Never past tense.

"Hey [Name], [MY_FIRST_NAME] with OSI Global. [One sentence new hook]. I'm sending you something right now, subject line is [Email 1 subject]. That's [MY_EMAIL_SPOKEN]."
...
Total span: roughly 22 business days (about 30 calendar days) from Email 1 to Email 3. Wider gaps than the new-outreach 3-email because re-engagement needs more breathing room.
...
Lead with the new hook. Company news, market trigger, or a product angle not covered in the original sequence. Do not re-introduce OSI. Do not acknowledge the previous sequence directly. Short, 3-4 sentences. One ask.

**Email 2 (10 business days after Email 1 actual send, 11 AM ET), Sequence Email**
Body: "Any thoughts?"

Then quoted Email 1 below in standard reply format:
> On [Email 1 actual send date], [MY_FULL_NAME] wrote:
> [Full Email 1 text]

No greeting. No sign-off. Just "Any thoughts?" and the quote.

**Email 3 (12 business days after Email 2 actual send, 12 PM ET), Sequence Email**
New subject line. Clean close. No ask. Leave the door open with one sentence. Examples:
...
7. Voicemails: 15 seconds max. No phone number. End with my email address spelled audibly ("that's [MY_EMAIL_SPOKEN]"). Always present or future tense ("I'm sending" or "I'm about to send"). Never past tense.
...
THE PLAY
[One tight paragraph: new angles for re-engagement + what was sent before + the attack plan. Only include Previous Employer OSI Client Check if a HubSpot match is found. Skip it entirely if no matches.]

--- EMAIL SEQUENCE ---
Email 1 - Day 1 - [Date] - Subject: [subject]
[full email body]

Email 2 - Day 14 - [Date] - Subject: RE: [subject]
Any thoughts?
---------- On [Date], [MY_FULL_NAME] wrote ----------
[Email 1 quoted]

Email 3 - Day 30 - [Date] - Subject: [new subject]
...
Type: LINKED_IN_CONNECT, due Day 1 (same date as Email 1 / 1st Touch), owner [MY_HUBSPOT_OWNER_ID].
