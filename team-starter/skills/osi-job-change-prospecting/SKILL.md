...
1. Search HubSpot for the contact by name.
   - If privacy-blocked on LinkedIn, use past companies to find them (see The Rules above).
...
- Not in HubSpot at all (create it, assign to [MY_HUBSPOT_OWNER_ID], then associate)
...
For companies NOT in HubSpot: create company record (owner: [MY_HUBSPOT_OWNER_ID]).
...
### Message guidelines
- Warm, peer-to-peer tone. the user speaks as a person, not a company.
